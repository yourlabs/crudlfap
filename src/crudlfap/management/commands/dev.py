...
Example to add a thread command, somewhere that will be imported at startup
(ie. yourproject/models.py if you added yourproject to INSTALLED_APPS which
autosettings() should do)::

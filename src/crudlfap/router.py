...
class Router(object):
    ...
    .. py:attribute:: actions
        ...
        List of :py:class:`~crudlfap.actions.Action`. :py:meth:`generate_views`
        will call the :py:meth:`~crudlfap.actions.Action.generate_views()`
        (userland) of each.
    """
    ...
    def generate_views(self, *views):
        ...
        for action in getattr(self, 'actions', []):
            ...
            for view in action.generate_views():
                result.append(view.clone(**kwargs))

  ...
  _createClass(_class, [{
    ...
    value: function open(e) {
      ...
      fetch(url, {
        ...
        _this2.modal = document.createElement('div');
        body.appendChild(_this2.modal);
        ...
        */
        ...
        _this2.wrapper.innerHTML = newbody.innerHTML;
        _this2.modal.appendChild(_this2.wrapper);
        _this2.footer = _this2.modal.querySelector('.modal-footer');
        _this2.content = _this2.modal.querySelector('.modal-content');
        (0, _init2.default)(_this2.wrapper);
        _this2.show();
      });
    }
  }, {
